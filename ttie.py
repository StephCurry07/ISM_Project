...
def ttieEncrypt(text, len, private_key):
    ...
    ttieImage.save('C:/Users/91892/TTIE_imgs/ttieOutput.png')
    ...
    ttieImage.save('C:/Users/91892/TTIE_imgs/ttieOutput2.png')
    return ttieImage
...
# wallpaper = PIL.Image.open("C:/Users/91892/TTIE_imgs/ttieOutput2Dec.png")
# wallpaper1 = ttie_image.convert("RGB")
wallpaper1 = PIL.Image.open("C:/Users/91892/Desktop/researchIntern.jpeg")

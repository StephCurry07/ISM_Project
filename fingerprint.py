...
test_original = cv2.imread("C:/Users/Zeus/Downloads/CyberSecProject/Finger-Print.tif")
cv2.imshow("Original", cv2.resize(test_original, None, fx=1, fy=1))
# cv2.waitKey(0)
# cv2.destroyAllWindows()

for file in [file for file in os.listdir("C:/Users/Zeus/Downloads/CyberSecProject/finger-prints/")]:
    fingerprint_database_image = cv2.imread("C:/Users/Zeus/Downloads/CyberSecProject/finger-prints/" + file)
